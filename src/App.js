...
const Navigation = () => {
  ...
  return (
    <Nav>
      ...
      <NavButton to="/scanner" className={location.pathname === '/scanner' ? 'active' : ''}>
        <FaBarcode size={16} /> Scanner
      </NavButton>
      <NavButton to="/tv" className={location.pathname === '/tv' ? 'active' : ''}>
        <FaTv size={16} /> Affichage TV
      </NavButton>
      <NavButton to="/stats" className={location.pathname === '/stats' ? 'active' : ''}>
        <FaChartBar size={16} /> Statistiques
      </NavButton>
    </Nav>
  );
};
